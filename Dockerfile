...
ENV BUILD_VERSION=4.30-9700-beta \
    SHA256_SUM=f579fa938f6d5d0622f23b3c163b3de5dc171e30175e44511bf269b3bb9fb1fc
...
RUN yum -y update \
    && yum -y install unzip iptables sysvinit-tools openssl \
